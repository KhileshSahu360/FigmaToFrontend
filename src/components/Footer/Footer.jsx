  ...
  return (
    ...
    <div className='bg-[#F9FAFF] mt-24 w-full flex flex-col items-center py-20'>
      <div className='w-[70%] gap-4 grid grid-cols-10 footer'>
        ...
        <div className='w-[70%] mt-20 footer'>
          <hr />
        </div>
        <div className='w-[70%] footer mt-20 grid grid-cols-2 pb-20'>
          <div className='flex flex-col gap-1'>
            ...
            <div className='flex gap-3'>
              <input type="text" placeholder='Enter email ID' className='border-2 outline-none focus:border-mainColor focus:border-2 rounded px-2 py-1'  />
              <Button className="bg-mainColor">Subscribe</Button>
            </div>
            <div>
